...
// Demo icon set with SVG strings (matching other libraries)
export const majesticons: IconItem[] = [
  {
    id: 'majesticons-home',
    name: 'Home',
    svg: `<svg viewBox="0 0 24 24" fill="none">
      <path d="M12 3l9 7.5v10.5a1 1 0 01-1 1H4a1 1 0 01-1-1V10.5L12 3z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
      <path d="M9 21v-6a1 1 0 011-1h4a1 1 0 011 1v6" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>`,
  ...
  },
  {
    ...
    svg: `<svg viewBox="0 0 24 24" fill="none">
      ...
      <path d="M6 20c0-4 2.7-6 6-6s6 2 6 6" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
    </svg>`,
  ...
  },
  {
    ...
    svg: `<svg viewBox="0 0 24 24" fill="none">
      ...
      <path d="m22 7-10 5L2 7" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>`,
