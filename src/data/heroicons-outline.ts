...
// Get all Heroicons outline by filtering the exported names
...
const getCategoryFromName = (name: string): string => {
  ...
  if (lowerName.includes('mail') || lowerName.includes('chat') || lowerName.includes('phone') || lowerName.includes('bell')) return 'communication';
  if (lowerName.includes('play') || lowerName.includes('pause') || lowerName.includes('music') || lowerName.includes('volume') || lowerName.includes('film')) return 'media';
  ...
  if (lowerName.includes('credit') || lowerName.includes('currency') || lowerName.includes('receipt') || lowerName.includes('calculator')) return 'finance';
  if (lowerName.includes('heart') || lowerName.includes('star') || lowerName.includes('share') || lowerName.includes('thumb')) return 'social';
  ...
  if (lowerName.includes('lightning') || lowerName.includes('fire') || lowerName.includes('sun') || lowerName.includes('moon')) return 'weather';
  if (lowerName.includes('location') || lowerName.includes('map') || lowerName.includes('globe') || lowerName.includes('office')) return 'location';
  ...
  if (lowerName.includes('eye') || lowerName.includes('search') || lowerName.includes('zoom') || lowerName.includes('view')) return 'view';
